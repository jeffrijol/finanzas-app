  ...
  return (
    <div class="w-full max-w-2xl mx-auto">
      <div
        ...
        onDragOver={handleDragOver}
        onDragLeave={handleDragLeave}
        class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center transition-colors duration-200 hover:border-blue-400 hover:bg-blue-50"
      >
        <p class="mt-2 text-sm text-gray-600">
          <span class="font-medium">Arrastra y suelta</span> tu archivo CSV aquí o
        </p>
        <button
          type="button"
          onClick={() => fileInputRef.current.click()}
          class="mt-2 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
        >
          Seleccionar archivo
        </button>
        <input
